...
TearCityLevel::TearCityLevel()
{
	...
	Bg* bg1 = GameplayStatics::CreateObject<Bg>({ 2500,350 }); bg1->Init("tearcity_1", -20, -20);
	Bg* bg2 = GameplayStatics::CreateObject<Bg>({ -1200,300 }); bg2->Init("tearcity_2", -15, -15);
	Bg* bg3 = GameplayStatics::CreateObject<Bg>({ 500,1000 }); bg3->Init("tearcity_3", -10, -10);


	Bg* ev0 = GameplayStatics::CreateObject<Bg>({ 0,600 }); ev0->Init("tearcity_environment_0", -3, -3, true);
	...
	Bg* ev1 = GameplayStatics::CreateObject<Bg>({ 0,975 }); ev1->Init("tearcity_environment_1", -2, -2);
	for (int i = 0; i < 5; i++) {
	...
	Bg* ev2 = GameplayStatics::CreateObject<Bg>({ -1000,800 }); ev2->Init("tearcity_environment_2", -3, -3);
	Bg* ev3 = GameplayStatics::CreateObject<Bg>({ -700,450 }); ev3->Init("tearcity_environment_3", 2, 2);

	Bg* ev4 = GameplayStatics::CreateObject<Bg>({ 500,1080 }); ev4->Init("tearcity_water", 4, 4);
	...
	Bg* ev7 = GameplayStatics::CreateObject<Bg>({ 1200,875 }); ev7->Init("tearcity_environment_6", 5);
	Bg* ev8 = GameplayStatics::CreateObject<Bg>({ 800,680 }); ev8->Init("tearcity_environment_7", 0);
	Bg* ev9 = GameplayStatics::CreateObject<Bg>({ 900,980 }); ev9->Init("tearcity_environment_8", 5, 5);
	GameplayStatics::CreateObject<Bg>({ 750,1075 })->Init("tearcity_environment_9", -2, -2);
	...
	GameplayStatics::CreateObject<Bg>({ 1580,975 })->Init("tearcity_environment_11", 4, 4);
	GameplayStatics::CreateObject<Bg>({ 1500,830 })->Init("tearcity_environment_12", -1, -1);
	GameplayStatics::CreateObject<Bg>({ -600,1050 })->Init("tearcity_environment_13", -2, -2);
	...
	GameplayStatics::CreateObject<Bg>({ -785,950 })->Init("tearcity_environment_15", 5, 5);
